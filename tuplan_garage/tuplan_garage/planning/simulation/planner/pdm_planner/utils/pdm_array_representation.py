...
def state_array_to_coords_array(
    ...
    # Reduce length / width
    half_length -= (length_width_reduction / 2)
    half_width -= (length_width_reduction / 2)
    # rear_axle_to_center -= (length_width_reduction / 2)

    # Scaling
    half_length *= scale_factor
    half_width *= scale_factor
    # rear_axle_to_center *= scale_factor
