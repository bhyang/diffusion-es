...
#     available_memory = int(0.99 * torch.cuda.mem_get_info(device)[0])
#     torch.cuda.caching_allocator_alloc(available_memory, device)
...
def main(cfg: DictConfig) -> Optional[TrainingEngine]:
    ...
    if cfg.py_func == 'train':
        ...
        with ProfilerContextManager(cfg.output_dir, cfg.enable_profiling, "validation"):
