...
class WithinBoundMetricBase(MetricBase):
    ...
    def __init__(self, name: str, category: str) -> None:
        ...
        self.within_bound_status_history = None
    ...
    def _compute_within_bound(
        ...
        return bool(np.all(ego_pose_value_within_bound)), ego_pose_value_within_bound
    ...
    def _compute_statistics(
        ...
        self.within_bound_status, self.within_bound_status_history = self._compute_within_bound(
