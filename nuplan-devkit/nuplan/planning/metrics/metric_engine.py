...
class MetricsEngine:
    ...
    def compute_metric_results(
        ...
        for metric in self._metrics:
            try:
                ...
                (
                    ...
                    other_results[metric.name]
                ) = metric.compute(history, scenario=scenario)
        ...
        return metric_results, other_results
    ...
    def compute(
        ...
        """
        all_metrics_results, all_other_results = self.compute_metric_results(history=history, scenario=scenario)
        ...
        return metric_files, all_other_results
