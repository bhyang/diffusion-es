...
do
    ...
    planner.pdm_diffusion_language_planner.language_config.instruction="Car 21 will slow for you. Change to the right lane. Once ahead of car 4 change to the left lane."
done
