...
do
    ...
    planner.pdm_diffusion_language_planner.language_config.instruction="Once ahead of car 12 change lanes to the left. Then slow down a lot and change lanes to the left. Once car 9 is ahead of you by a few meters change lanes to the left."
done
